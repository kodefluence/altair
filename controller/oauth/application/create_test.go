...
func TestCreate(t *testing.T) {
	...
	t.Run("Method", func(t *testing.T) {
		...
		assert.Equal(t, "POST", controller.Oauth().Application().Create(applicationManager).Method())
	})

	t.Run("Path", func(t *testing.T) {
		applicationManager := mock.NewMockApplicationManager(mockCtrl)
		assert.Equal(t, "/oauth/applications", controller.Oauth().Application().Create(applicationManager).Path())
	})
	...
	t.Run("Control", func(t *testing.T) {
		t.Run("Given request with json body", func(t *testing.T) {
			t.Run("Return oauth application data with status 202", func(t *testing.T) {
				...
				ctrl := controller.Oauth().Application().Create(applicationManager)
