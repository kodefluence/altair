...
func TestList(t *testing.T) {
	...
	t.Run("Method", func(t *testing.T) {
		...
		assert.Equal(t, "GET", controller.Oauth().Application().List(applicationManager).Method())
	})

	t.Run("Path", func(t *testing.T) {
		applicationManager := mock.NewMockApplicationManager(mockCtrl)
		assert.Equal(t, "/oauth/applications", controller.Oauth().Application().List(applicationManager).Path())
	})
	...
	t.Run("Control", func(t *testing.T) {
		t.Run("Given request with offset and limit", func(t *testing.T) {
			t.Run("Return list of oauth application", func(t *testing.T) {
				...
				ctrl := controller.Oauth().Application().List(applicationManager)
