...
func TestOne(t *testing.T) {
	...
	t.Run("Method", func(t *testing.T) {
		...
		assert.Equal(t, "GET", controller.Oauth().Application().One(applicationManager).Method())
	})

	t.Run("Path", func(t *testing.T) {
		applicationManager := mock.NewMockApplicationManager(mockCtrl)
		assert.Equal(t, "/oauth/applications/:id", controller.Oauth().Application().One(applicationManager).Path())
	})
	...
	t.Run("Control", func(t *testing.T) {
		t.Run("Given id params", func(t *testing.T) {
			t.Run("Return oauth application data", func(t *testing.T) {
				...
				ctrl := controller.Oauth().Application().One(applicationManager)
